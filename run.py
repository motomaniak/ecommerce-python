...
from app.views.index import Reviews, Checkout, Orders, Categories, OrderDetails, Customer, Register, Product, Products, Login, AddProdcutToOrder, Order, Cart
...
api.add_resource(Reviews, '/api/reviews/<int:id>')
